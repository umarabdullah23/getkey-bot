...
const AIHELP_SYSTEM =
  ...
  "STYLE: Answer the user's ACTUAL question directly and CONCISELY. Prefer a SINGLE short Discord message (aim under ~1200 characters; never pad). Lead with the few most impactful points as a tight bullet list with exact settings/numbers. Use light Discord markdown (a bold word or short header, bullets); light emoji ok. Skip anything they didn't ask about, and offer to go deeper instead of dumping everything.\n\n" +
